package org.carbon.component.generator.aop.interceptor;

import net.sf.cglib.proxy.MethodInterceptor;
import net.sf.cglib.proxy.MethodProxy;
import org.carbon.component.generator.aop.annotation.InOutLogging;
...
public class InOutLoggingInterceptor implements MethodInterceptor{
	...
	private void log(Object obj, Method method, Object[] args, Object result) {
		...
		List<SimpleKeyValue> list = Arrays.asList(
