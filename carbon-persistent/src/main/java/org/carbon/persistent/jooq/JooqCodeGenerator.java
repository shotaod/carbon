...
public class JooqCodeGenerator {
    ...
    public JooqCodeGenerator(String url, String user, String password, Class<? extends Driver> driverClass, SQLDialect dialect, String schema, String packageName, File outputDir) {
        this.url = url;
        this.user = user;
