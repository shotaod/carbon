...
public interface ISchemaVersion extends Serializable {
     ...
     */
    public void from(org.carbon.sample.heroku.ext.jooq.tables.interfaces.ISchemaVersion from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface ISchemaVersion
     */
    public <E extends org.carbon.sample.heroku.ext.jooq.tables.interfaces.ISchemaVersion> E into(E into);
}
