...
ALTER SEQUENCE auth_client_id_seq OWNED BY auth_client.id;
...
ALTER TABLE ONLY auth_client ALTER COLUMN id SET DEFAULT nextval('auth_client_id_seq'::regclass);
...
CREATE UNIQUE INDEX auth_client_client_host_uindex ON auth_client USING btree (client_host);
...
CREATE UNIQUE INDEX auth_client_client_id_uindex ON auth_client USING btree (client_id);
